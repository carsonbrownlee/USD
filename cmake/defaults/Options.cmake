...
option(PXR_BUILD_OSPRAY_PLUGIN "Build embree imaging plugin" OFF)
...
if (${PXR_BUILD_OSPRAY_PLUGIN} AND NOT ${PXR_BUILD_IMAGING})
    message(STATUS
        "PXR_BUILD_IMAGING=OFF implies PXR_BUILD_OSPRAY_PLUGIN=OFF"
    )
endif()
